...
#define myWarning (qWarning().nospace() << "Core::SettingCatalog::" << __func__ << "():").space()
    ...
    void SettingCatalogPrivate::addPageRecursive(ISettingPage *page) {
        auto doIt = [this](ISettingPage *page) {
            ...
            connect(page, &ISettingPage::descriptionChanged, this,
    ...
    void SettingCatalogPrivate::removePageRecursive(ISettingPage *page) {
        auto doIt = [this](ISettingPage *page) {
            ...
            disconnect(page, &ISettingPage::titleChanged, this,
                       &SettingCatalogPrivate::_q_pageTitleChanged);
    ...
    SettingCatalog::SettingCatalog(QObject *parent)
        : SettingCatalog(*new SettingCatalogPrivate(), parent) {
    }
    ...
    SettingCatalog::SettingCatalog(SettingCatalogPrivate &d, QObject *parent)
