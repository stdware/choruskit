...
#define myWarning(func) (qWarning().nospace() << "Core::ActionDomain::" << (func) << "():").space()
    ...
    static QHash<QString, QMChronoMap<QString, RuleData>> parseStateToMap(const ActionDomainState &state) {
        QHash<QString, QMChronoMap<QString, RuleData>> map;
        int randomIdCount = 0;
    ...
    ActionDomainState ActionDomainPrivate::calcState(const ActionDomainState &existingState,
        ...
        QHash<QString, QMChronoMap<QString, RuleData>> myState = parseStateToMap(existingState);
    ...
    static void recursiveFillActions(const ActionDomainPrivate *d, MenuClass *menu, const QString &id,
                                     ...
                                     const QHash<QString, QMChronoMap<QString, RuleData>> &myState,
